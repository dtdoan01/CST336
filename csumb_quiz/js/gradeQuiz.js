$(document).ready(function(){
    ...
    $("form").submit(function(event) {
        ...
        var answer4 = $("input[name='question4']:checked").val();
          ...
          var selector = document.getElementById('question3');
        ...
        $("#question3-feedback").append("The answer is <strong>Internet Programming</strong>");

        if (answer4 === "D" || (answer4 === "A" && answer4 === "B" && answer4 === "C")) {
            correctAnswer($("#question4-feedback"));
        } else {
            incorrectAnswer($("#question4-feedback"));
        }
        $("#question4-feedback").append("The answer is <strong>All of above Mentioned</strong>");
